...
namespace LoopClient
{
    ...
    public class ListViewColumnSorter : System.Collections.IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            else if (xText.StartsWith("v")&&yText.StartsWith("v"))
            {

                  compareResult = CompareCode(xText, yText);
            }
            else
            {
                //比较对象
        ...
        private int CompareCode(string v1, string v2)
        {

          int  x = Convert.ToInt32(v1.Substring(1, v1.Length-1));
          int y = Convert.ToInt32(v2.Substring(1, v2.Length - 1));
